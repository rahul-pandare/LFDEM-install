...
private:
	...
	void setupInteractionManager(const std::vector <struct Interactions::contact_state> &contact_states);
	void setupInteractionManager(const std::vector <struct Interactions::contact_state> &contact_states,
 ...
 public:
	...
	void setupConfiguration(const struct activated_adhesion_configuration &config, Parameters::ControlVariable control_);
	void setupConfiguration(const struct ageing_contact_configuration &config, Parameters::ControlVariable control_);
